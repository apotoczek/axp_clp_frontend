...
export function LabelSettings({
    ...
    return (
        ...
        >
            ...
            />
            {!noCustomDataInterval && axisFormat !== undefined && (
                <>
    ...
    return (
        <Collapsible header={header} isOpen={isOpen} toggleOpen={() => setIsOpen(!isOpen)}>
            ...
            <Flex mb={1}>
                ...
                />
                <DropdownList
                    leftLabel='Labels Position'
                    value={provider.settingsValueForComponent(['dataPointLabel', 'inside'], true)}
                    options={[
                        {label: 'Inside', value: true},
                        {label: 'Outside', value: false},
                    ]}
                    onValueChanged={value => onLabelSettingChanged({key: 'inside', value})}
                />
            </Flex>
            <InfoTextDropdown
