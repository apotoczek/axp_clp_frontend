...
export default function(opts, components) {
    ...
    let chart_wrapper = {
        ...
        layout: {
            body: ['default', 'by_client', 'by_period'],
        },
    ...
    let by_client_table = Object.assign(MetricsHelper.get_datatable_config({}), {
        id: 'by_client',
        label: 'Updated cash flows grouped by client',
        columns: MetricsHelper.get_columns_from_keys(['client_name', 'upload_count']),
        datasource: MetricsHelper.get_datasource({
            target: 'commander:user_fund_updates',
            period_event: self.page_events.get('time_period_changed'),
            group_by: 'client',
    ...
    let group_by = {
        ...
        data: [
            ...
            {label: 'Grouped by Client', value: {group_by: 'by_client'}},
