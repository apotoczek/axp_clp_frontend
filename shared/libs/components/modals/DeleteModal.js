...
export default function(opts, components) {
    ...
    self._delete_entities = DataThing.backends.useractionhandler({
        url: 'delete_entities',
    });
        ...
        if (data && data.length > 0) {
            ...
            self._delete_entities({
                ...
                success: DataThing.api.XHRSuccess(() => {
                    ...
                    Observer.broadcast_for_id(self.get_id(), 'DeleteModal.delete_entities', {
                        user_fund_uids: user_fund_uids,
                        portfolio_uids: portfolio_uids,
                        user_market_uids: user_market_uids,
                    });

                    Observer.broadcast('DeleteModal.delete_entities', {
                        user_fund_uids: user_fund_uids,
                        portfolio_uids: portfolio_uids,
                        user_market_uids: user_market_uids,
                    });
