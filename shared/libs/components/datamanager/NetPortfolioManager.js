...
import CommitmentPlans from 'src/libs/components/datamanager/CommitmentPlans';
...
import DeleteCommitmentPlansModal from 'src/libs/components/modals/DeleteCommitmentPlansModal';
...
export default function(opts, components) {
    ...
    self.events.resolve_and_add('download_commitments', 'ActionButton.action.download_commitments');
    self._download_commitments = DataThing.backends.useractionhandler({
        url: 'download_commitments',
    });
    Observer.register(self.events.get('download_commitments'), () => {
        self._download_commitments({
            data: {
        ...
        components: [
            {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        state: 'commitment_plans',
                        disabled_callback: () => !config.hl,
                    },
                    {
                        label: 'Funds',
                        state: 'funds',
    ...
    self.commitment_plans_tools_menu = {
        id: 'commitment_plans_tools_menu',
        component: ActionHeader,
        template: 'tpl_action_toolbar',
        disable_export: true,
        buttons: [
            {
                ...
                label:
                    'Download template <span style="padding-left:3px" class="glyphicon glyphicon-download-alt"></span> ',
                action: 'download_commitments',
                css: {
                    'pull-right': true,
                },
                id_callback: self.events.register_alias('download_commitments'),
            },
            {
                id: 'new_commitments',
                label: 'New <span class="icon-plus"></span>',
                action: 'new_commitments',
                css: {
                    btn: true,
            ...
            DataManagerHelper.buttons.delete_entities({
                data_table_id: Utils.gen_id(
                    ...
                    'body',
                    'commitment_plans',
                    'commitment_plans_table',
                ),
                component: DeleteCommitmentPlansModal,
    ...
    self.body = self.new_instance(DynamicWrapper, {
        ...
        components: [
            ...
            },
            {
                ...
                spreadsheet_instructions: ko.observable(true),
                table_filter_conf: {
                    type: 'dynamic',
                    query: {
                        name: {
