...
define([
    ...
    function() {
        ...
        var _injectGoogleMapsScript = function(){
            ...
            if(window.location.host.indexOf('bison.null') > -1) {
                var api_key = 'AIzaSyA9DEIA3DaIlE04IZlYRqEch3HNe6qsPDw';
            } else {
                var api_key = 'AIzaSyBntWPBAN-OLkbtBtIFizuUsM3M4GsoHvA';
            }

            var src = 'https://maps.googleapis.com/maps/api/js?key=' + api_key + '&libraries=places&callback=' + _googleMapsCallbackId;
