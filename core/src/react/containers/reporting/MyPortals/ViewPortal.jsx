...
export default function ViewPortal() {
    ...
    const toggleModal = usePartiallyAppliedCallback(key => {
        setActiveModal(activeModal => (activeModal ? null : key));
    }, []);
    ...
    const {data: requestData, error: requestsError, isLoading: requestsLoading} = useBackendData(
        ...
        {relationship_uid: uid, include_approved: false},
    ...
    const allowEditRelationship = true;
            ...
            <Toolbar flex>
                ...
                {allowEditRelationship && (
                    <ConfirmDropdown
                        ...
                        subText='All requests and submissions associated with the portal will be deleted as well.'
...
function PageContent({
    ...
    if (!relationship || error) {
        return <Error title='Portal Not Found' body='The selected portal does not exist' />;
    }
